...
(self['webpackChunkcloud_clourier'] = self['webpackChunkcloud_clourier'] || []).push([
  [
    'vendors-node_modules_react-cropper_dist_react-cropper_umd_js-node_modules_spark-md5_spark-md5-76bc40',
  ],
  {
  ...
  \********************************************************/
      /***/ function (module) {
        'use strict';
        eval(
          '\n\nmodule.exports = function (url, options) {\n  if (!options) {\n    options = {};\n  }\n\n  if (!url) {\n    return url;\n  }\n\n  url = String(url.__esModule ? url.default : url); // If url is already wrapped in quotes, remove them\n\n  if (/^[\'"].*[\'"]$/.test(url)) {\n    url = url.slice(1, -1);\n  }\n\n  if (options.hash) {\n    url += options.hash;\n  } // Should url be wrapped?\n  // See https://drafts.csswg.org/css-values-3/#urls\n\n\n  if (/["\'() \\t\\n]|(%20)/.test(url) || options.needQuotes) {\n    return "\\"".concat(url.replace(/"/g, \'\\\\"\').replace(/\\n/g, "\\\\n"), "\\"");\n  }\n\n  return url;\n};\n\n//# sourceURL=webpack://cloud-clourier/./node_modules/css-loader/dist/runtime/getUrl.js?',
        );
